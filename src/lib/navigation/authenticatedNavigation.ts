...
const authenticatedNavigationRegistry: Record<UserRole, AuthenticatedNavigationConfig> = {
  PUBLIC: {
    ...
    secondaryActions: [
      ...
      {
        id: 'about',
        label: 'About FareCheck',
        shortLabel: 'About',
        icon: DASHBOARD_ICONS.info,
        href: '/profile/about',
        matchers: [prefix('/profile/about')],
      },
      {
        id: 'feedback',
        label: 'Send Feedback',
        ...
        matchers: [prefix('/profile/feedback')],
      },
      {
        id: 'discount-card',
        label: 'Discount Card',
  ...
  ADMIN: {
    ...
    secondaryActions: [
      ...
      },
      {
        ...
        icon: DASHBOARD_ICONS.feedback,
        href: '/admin/feedback',
        matchers: [prefix('/admin/feedback')],
      },
      {
        id: 'users',
